function SHAPES = shapefactor(FlowMap, dx, VentLocation, DEM)
    ...
    % Inputs 
    % FlowMap   : Logical matrix of flow shape. 1 in flow locations 
    % dx        : resoltion of matrix in meters 
    % VentLocation: [x,y] location of vent 
    % Optional:
    % DEM   : optional to calculate gap wavelength 

    % Output 
    % Shapes    : structure containing 
...
if sum(FlowMap(:))<10
    ...
    FlowAngle= atand(FlowDir(2)/FlowDir(1)); 
